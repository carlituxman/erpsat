...
class PaisesYComunidadesSeeder extends Seeder {
    ...
    public function run()
    {
        // DB::table('base_paises')->delete();
        // DB::table('base_estados')->delete();

        $paises = [
            [4,'AF','Afghanistan','AS','AFN','Afghani'],
            [8,'AL','Albania','EU','ALL','Lek'],
            [10,'AQ','Antarctica','AN','',''],
            [12,'DZ','Algeria','AF','DZD','Dinar'],
            [16,'AS','American Samoa','OC','USD','Dollar'],
            [20,'AD','Andorra','EU','EUR','Euro'],
            [24,'AO','Angola','AF','AOA','Kwanza'],
            [28,'AG','Antigua and Barbuda','NA','XCD','Dollar'],
            [31,'AZ','Azerbaijan','AS','AZN','Manat'],
            [32,'AR','Argentina','SA','ARS','Peso'],
            [36,'AU','Australia','OC','AUD','Dollar'],
            [40,'AT','Austria','EU','EUR','Euro'],
            [44,'BS','Bahamas','NA','BSD','Dollar'],
            [48,'BH','Bahrain','AS','BHD','Dinar'],
            [50,'BD','Bangladesh','AS','BDT','Taka'],
            [51,'AM','Armenia','AS','AMD','Dram'],
            [52,'BB','Barbados','NA','BBD','Dollar'],
            [56,'BE','Belgium','EU','EUR','Euro'],
            [60,'BM','Bermuda','NA','BMD','Dollar'],
            [64,'BT','Bhutan','AS','BTN','Ngultrum'],
            [68,'BO','Bolivia','SA','BOB','Boliviano'],
            [70,'BA','Bosnia and Herzegovina','EU','BAM','Marka'],
            [72,'BW','Botswana','AF','BWP','Pula'],
            [74,'BV','Bouvet Island','AN','NOK','Krone'],
            [76,'BR','Brazil','SA','BRL','Real'],
            [84,'BZ','Belize','NA','BZD','Dollar'],
            [86,'IO','British Indian Ocean Territory','AS','USD','Dollar'],
            [90,'SB','Solomon Islands','OC','SBD','Dollar'],
            [92,'VG','British Virgin Islands','NA','USD','Dollar'],
            [96,'BN','Brunei','AS','BND','Dollar'],
            [100,'BG','Bulgaria','EU','BGN','Lev'],
            [104,'MM','Myanmar','AS','MMK','Kyat'],
            [108,'BI','Burundi','AF','BIF','Franc'],
            [112,'BY','Belarus','EU','BYR','Ruble'],
            [116,'KH','Cambodia','AS','KHR','Riels'],
            [120,'CM','Cameroon','AF','XAF','Franc'],
            [124,'CA','Canada','NA','CAD','Dollar'],
            [132,'CV','Cape Verde','AF','CVE','Escudo'],
            [136,'KY','Cayman Islands','NA','KYD','Dollar'],
            [140,'CF','Central African Republic','AF','XAF','Franc'],
            [144,'LK','Sri Lanka','AS','LKR','Rupee'],
            [148,'TD','Chad','AF','XAF','Franc'],
            [152,'CL','Chile','SA','CLP','Peso'],
            [156,'CN','China','AS','CNY','Yuan Renminbi'],
            [158,'TW','Taiwan','AS','TWD','Dollar'],
            [162,'CX','Christmas Island','AS','AUD','Dollar'],
            [166,'CC','Cocos Islands','AS','AUD','Dollar'],
            [170,'CO','Colombia','SA','COP','Peso'],
            [174,'KM','Comoros','AF','KMF','Franc'],
            [175,'YT','Mayotte','AF','EUR','Euro'],
            [178,'CG','Republic of the Congo','AF','XAF','Franc'],
            [180,'CD','Democratic Republic of the Congo','AF','CDF','Franc'],
            [184,'CK','Cook Islands','OC','NZD','Dollar'],
            [188,'CR','Costa Rica','NA','CRC','Colon'],
            [191,'HR','Croatia','EU','HRK','Kuna'],
            [192,'CU','Cuba','NA','CUP','Peso'],
            [196,'CY','Cyprus','EU','EUR','Euro'],
            [203,'CZ','Czech Republic','EU','CZK','Koruna'],
            [204,'BJ','Benin','AF','XOF','Franc'],
            [208,'DK','Denmark','EU','DKK','Krone'],
            [212,'DM','Dominica','NA','XCD','Dollar'],
            [214,'DO','Dominican Republic','NA','DOP','Peso'],
            [218,'EC','Ecuador','SA','USD','Dollar'],
            [222,'SV','El Salvador','NA','USD','Dollar'],
            [226,'GQ','Equatorial Guinea','AF','XAF','Franc'],
            [231,'ET','Ethiopia','AF','ETB','Birr'],
            [232,'ER','Eritrea','AF','ERN','Nakfa'],
            [233,'EE','Estonia','EU','EEK','Kroon'],
            [234,'FO','Faroe Islands','EU','DKK','Krone'],
            [238,'FK','Falkland Islands','SA','FKP','Pound'],
            [239,'GS','South Georgia and the South Sandwich Islands','AN','GBP','Pound'],
            [242,'FJ','Fiji','OC','FJD','Dollar'],
            [246,'FI','Finland','EU','EUR','Euro'],
            [248,'AX','Aland Islands','EU','EUR','Euro'],
            [250,'FR','France','EU','EUR','Euro'],
            [254,'GF','French Guiana','SA','EUR','Euro'],
            [258,'PF','French Polynesia','OC','XPF','Franc'],
            [260,'TF','French Southern Territories','AN','EUR','Euro  '],
            [262,'DJ','Djibouti','AF','DJF','Franc'],
            [266,'GA','Gabon','AF','XAF','Franc'],
            [268,'GE','Georgia','AS','GEL','Lari'],
            [270,'GM','Gambia','AF','GMD','Dalasi'],
            [275,'PS','Palestinian Territory','AS','ILS','Shekel'],
            [276,'DE','Germany','EU','EUR','Euro'],
            [288,'GH','Ghana','AF','GHS','Cedi'],
            [292,'GI','Gibraltar','EU','GIP','Pound'],
            [296,'KI','Kiribati','OC','AUD','Dollar'],
            [300,'GR','Greece','EU','EUR','Euro'],
            [304,'GL','Greenland','NA','DKK','Krone'],
            [308,'GD','Grenada','NA','XCD','Dollar'],
            [312,'GP','Guadeloupe','NA','EUR','Euro'],
            [316,'GU','Guam','OC','USD','Dollar'],
            [320,'GT','Guatemala','NA','GTQ','Quetzal'],
            [324,'GN','Guinea','AF','GNF','Franc'],
            [328,'GY','Guyana','SA','GYD','Dollar'],
            [332,'HT','Haiti','NA','HTG','Gourde'],
            [334,'HM','Heard Island and McDonald Islands','AN','AUD','Dollar'],
            [336,'VA','Vatican','EU','EUR','Euro'],
            [340,'HN','Honduras','NA','HNL','Lempira'],
            [344,'HK','Hong Kong','AS','HKD','Dollar'],
            [348,'HU','Hungary','EU','HUF','Forint'],
            [352,'IS','Iceland','EU','ISK','Krona'],
            [356,'IN','India','AS','INR','Rupee'],
            [360,'ID','Indonesia','AS','IDR','Rupiah'],
            [364,'IR','Iran','AS','IRR','Rial'],
            [368,'IQ','Iraq','AS','IQD','Dinar'],
            [372,'IE','Ireland','EU','EUR','Euro'],
            [376,'IL','Israel','AS','ILS','Shekel'],
            [380,'IT','Italy','EU','EUR','Euro'],
            [384,'CI','Ivory Coast','AF','XOF','Franc'],
            [388,'JM','Jamaica','NA','JMD','Dollar'],
            [392,'JP','Japan','AS','JPY','Yen'],
            [398,'KZ','Kazakhstan','AS','KZT','Tenge'],
            [400,'JO','Jordan','AS','JOD','Dinar'],
            [404,'KE','Kenya','AF','KES','Shilling'],
            [408,'KP','North Korea','AS','KPW','Won'],
            [410,'KR','South Korea','AS','KRW','Won'],
            [414,'KW','Kuwait','AS','KWD','Dinar'],
            [417,'KG','Kyrgyzstan','AS','KGS','Som'],
            [418,'LA','Laos','AS','LAK','Kip'],
            [422,'LB','Lebanon','AS','LBP','Pound'],
            [426,'LS','Lesotho','AF','LSL','Loti'],
            [428,'LV','Latvia','EU','LVL','Lat'],
            [430,'LR','Liberia','AF','LRD','Dollar'],
            [434,'LY','Libya','AF','LYD','Dinar'],
            [438,'LI','Liechtenstein','EU','CHF','Franc'],
            [440,'LT','Lithuania','EU','LTL','Litas'],
            [442,'LU','Luxembourg','EU','EUR','Euro'],
            [446,'MO','Macao','AS','MOP','Pataca'],
            [450,'MG','Madagascar','AF','MGA','Ariary'],
            [454,'MW','Malawi','AF','MWK','Kwacha'],
            [458,'MY','Malaysia','AS','MYR','Ringgit'],
            [462,'MV','Maldives','AS','MVR','Rufiyaa'],
            [466,'ML','Mali','AF','XOF','Franc'],
            [470,'MT','Malta','EU','EUR','Euro'],
            [474,'MQ','Martinique','NA','EUR','Euro'],
            [478,'MR','Mauritania','AF','MRO','Ouguiya'],
            [480,'MU','Mauritius','AF','MUR','Rupee'],
            [484,'MX','Mexico','NA','MXN','Peso'],
            [492,'MC','Monaco','EU','EUR','Euro'],
            [496,'MN','Mongolia','AS','MNT','Tugrik'],
            [498,'MD','Moldova','EU','MDL','Leu'],
            [499,'ME','Montenegro','EU','EUR','Euro'],
            [500,'MS','Montserrat','NA','XCD','Dollar'],
            [504,'MA','Morocco','AF','MAD','Dirham'],
            [508,'MZ','Mozambique','AF','MZN','Meticail'],
            [512,'OM','Oman','AS','OMR','Rial'],
            [516,'NA','Namibia','AF','NAD','Dollar'],
            [520,'NR','Nauru','OC','AUD','Dollar'],
            [524,'NP','Nepal','AS','NPR','Rupee'],
            [528,'NL','Netherlands','EU','EUR','Euro'],
            [530,'AN','Netherlands Antilles','NA','ANG','Guilder'],
            [533,'AW','Aruba','NA','AWG','Guilder'],
            [540,'NC','New Caledonia','OC','XPF','Franc'],
            [548,'VU','Vanuatu','OC','VUV','Vatu'],
            [554,'NZ','New Zealand','OC','NZD','Dollar'],
            [558,'NI','Nicaragua','NA','NIO','Cordoba'],
            [562,'NE','Niger','AF','XOF','Franc'],
            [566,'NG','Nigeria','AF','NGN','Naira'],
            [570,'NU','Niue','OC','NZD','Dollar'],
            [574,'NF','Norfolk Island','OC','AUD','Dollar'],
            [578,'NO','Norway','EU','NOK','Krone'],
            [580,'MP','Northern Mariana Islands','OC','USD','Dollar'],
            [581,'UM','United States Minor Outlying Islands','OC','USD','Dollar '],
            [583,'FM','Micronesia','OC','USD','Dollar'],
            [584,'MH','Marshall Islands','OC','USD','Dollar'],
            [585,'PW','Palau','OC','USD','Dollar'],
            [586,'PK','Pakistan','AS','PKR','Rupee'],
            [591,'PA','Panama','NA','PAB','Balboa'],
            [598,'PG','Papua New Guinea','OC','PGK','Kina'],
            [600,'PY','Paraguay','SA','PYG','Guarani'],
            [604,'PE','Peru','SA','PEN','Sol'],
            [608,'PH','Philippines','AS','PHP','Peso'],
            [612,'PN','Pitcairn','OC','NZD','Dollar'],
            [616,'PL','Poland','EU','PLN','Zloty'],
            [620,'PT','Portugal','EU','EUR','Euro'],
            [624,'GW','Guinea-Bissau','AF','XOF','Franc'],
            [626,'TL','East Timor','OC','USD','Dollar'],
            [630,'PR','Puerto Rico','NA','USD','Dollar'],
            [634,'QA','Qatar','AS','QAR','Rial'],
            [638,'RE','Reunion','AF','EUR','Euro'],
            [642,'RO','Romania','EU','RON','Leu'],
            [643,'RU','Russia','EU','RUB','Ruble'],
            [646,'RW','Rwanda','AF','RWF','Franc'],
            [652,'BL','Saint Barthélemy','NA','EUR','Euro'],
            [654,'SH','Saint Helena','AF','SHP','Pound'],
            [659,'KN','Saint Kitts and Nevis','NA','XCD','Dollar'],
            [660,'AI','Anguilla','NA','XCD','Dollar'],
            [662,'LC','Saint Lucia','NA','XCD','Dollar'],
            [663,'MF','Saint Martin','NA','EUR','Euro'],
            [666,'PM','Saint Pierre and Miquelon','NA','EUR','Euro'],
            [670,'VC','Saint Vincent and the Grenadines','NA','XCD','Dollar'],
            [674,'SM','San Marino','EU','EUR','Euro'],
            [678,'ST','Sao Tome and Principe','AF','STD','Dobra'],
            [682,'SA','Saudi Arabia','AS','SAR','Rial'],
            [686,'SN','Senegal','AF','XOF','Franc'],
            [688,'RS','Serbia','EU','RSD','Dinar'],
            [690,'SC','Seychelles','AF','SCR','Rupee'],
            [694,'SL','Sierra Leone','AF','SLL','Leone'],
            [702,'SG','Singapore','AS','SGD','Dollar'],
            [703,'SK','Slovakia','EU','EUR','Euro'],
            [704,'VN','Vietnam','AS','VND','Dong'],
            [705,'SI','Slovenia','EU','EUR','Euro'],
            [706,'SO','Somalia','AF','SOS','Shilling'],
            [710,'ZA','South Africa','AF','ZAR','Rand'],
            [716,'ZW','Zimbabwe','AF','ZWL','Dollar'],
            [724,'ES','España','EU','EUR','Euro'],
            [732,'EH','Western Sahara','AF','MAD','Dirham'],
            [736,'SD','Sudan','AF','SDG','Dinar'],
            [740,'SR','Suriname','SA','SRD','Dollar'],
            [744,'SJ','Svalbard and Jan Mayen','EU','NOK','Krone'],
            [748,'SZ','Swaziland','AF','SZL','Lilangeni'],
            [752,'SE','Sweden','EU','SEK','Krona'],
            [756,'CH','Switzerland','EU','CHF','Franc'],
            [760,'SY','Syria','AS','SYP','Pound'],
            [762,'TJ','Tajikistan','AS','TJS','Somoni'],
            [764,'TH','Thailand','AS','THB','Baht'],
            [768,'TG','Togo','AF','XOF','Franc'],
            [772,'TK','Tokelau','OC','NZD','Dollar'],
            [776,'TO','Tonga','OC','TOP','Pa\'anga'],
            [780,'TT','Trinidad and Tobago','NA','TTD','Dollar'],
            [784,'AE','United Arab Emirates','AS','AED','Dirham'],
            [788,'TN','Tunisia','AF','TND','Dinar'],
            [792,'TR','Turkey','AS','TRY','Lira'],
            [795,'TM','Turkmenistan','AS','TMT','Manat'],
            [796,'TC','Turks and Caicos Islands','NA','USD','Dollar'],
            [798,'TV','Tuvalu','OC','AUD','Dollar'],
            [800,'UG','Uganda','AF','UGX','Shilling'],
            [804,'UA','Ukraine','EU','UAH','Hryvnia'],
            [807,'MK','Macedonia','EU','MKD','Denar'],
            [818,'EG','Egypt','AF','EGP','Pound'],
            [826,'GB','United Kingdom','EU','GBP','Pound'],
            [831,'GG','Guernsey','EU','GBP','Pound'],
            [832,'JE','Jersey','EU','GBP','Pound'],
            [833,'IM','Isle of Man','EU','GBP','Pound'],
            [834,'TZ','Tanzania','AF','TZS','Shilling'],
            [840,'US','United States','NA','USD','Dollar'],
            [850,'VI','U.S. Virgin Islands','NA','USD','Dollar'],
            [854,'BF','Burkina Faso','AF','XOF','Franc'],
            [855,'XK','Kosovo','EU','EUR','Euro'],
            [858,'UY','Uruguay','SA','UYU','Peso'],
            [860,'UZ','Uzbekistan','AS','UZS','Som'],
            [862,'VE','Venezuela','SA','VEF','Bolivar'],
            [876,'WF','Wallis and Futuna','OC','XPF','Franc'],
            [882,'WS','Samoa','OC','WST','Tala'],
            [887,'YE','Yemen','AS','YER','Rial'],
            [891,'CS','Serbia and Montenegro','EU','RSD','Dinar'],
            [894,'ZM','Zambia','AF','ZMK','Kwacha']
        ];
        ...
        $estados = [
            ...
            [3091,724,'Islas baleares','Europe/Madrid'],
            [3092,724,'La Rioja','Europe/Madrid'],
            [3093,724,'Madrid','Europe/Madrid'],
            [3094,724,'Murcia','Europe/Madrid'],
            [3095,724,'Navarra','Europe/Madrid'],
            [3096,724,'Asturias','Europe/Madrid'],
            [3097,724,'Cantabria','Europe/Madrid'],
            [3098,724,'Andalucía','Europe/Madrid'],
            [3099,724,'Aragon','Europe/Madrid'],
            [3100,724,'Islas canarias','Atlantic/Canary'],
            [3101,724,'Castilla-La Mancha','Europe/Madrid'],
            [3102,724,'Castilla y León','Europe/Madrid'],
            [3103,724,'Cataluña','Europe/Madrid'],
            [3104,724,'Extremadura','Europe/Madrid'],
            [3105,724,'Galicia','Europe/Madrid'],
            [3106,724,'País Vasco','Europe/Madrid'],
        ...
        {
            DB::table('base_paises')->insert([
                'id' => $pais[0],
                'codigo' => $pais[1],
                'nombre' => $pais[2],
                'continente' => $pais[3],
                'codigo_moneda' => $pais[4],
                'nombre_moneda' => $pais[5],
            ]);
        }

        foreach($estados as $estado)
        {
            DB::table('base_estados')->insert([
                'id' => $estado[0],
                'pais_id' => $estado[1],
                'nombre' => $estado[2],
                'zona_horaria' => $estado[3],
            ]);
        }
    }
